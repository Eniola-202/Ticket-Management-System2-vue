...
import { useAuth, validateEmail, validatePassword, validateName, Toast } from '../constants/contants.js'
...
export default {
  ...
  setup(props) {
    ...
    const handleSubmit = async (e) => {
      ...
      const result = signup(formData.value.name, formData.value.email, formData.value.password)
